  ...
  return (
    <div className='home'>
      <div className='about'>
        ...
        <div className='prompt'>
          ...
          <center>
            ...
            <a href='mailto:monyorodemongare@gmail.com' target='_blank' rel='noopener noreferrer'>
              <Email />
            </a>
            <a href='https://github.com/moabmo' target='_blank' rel='noopener noreferrer'>
              <GitHub />
            </a>
          </center>
        </div>
      ...
      <div className='skills'>
        <h1>Skills</h1>
        <div className='list'>
          <ul> {/* Wrap the <li> elements within an unordered list */}
            <li className='item'>
              <h2>Front-End</h2>
